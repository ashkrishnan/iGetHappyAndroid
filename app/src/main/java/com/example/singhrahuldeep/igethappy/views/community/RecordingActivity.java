...
import com.example.singhrahuldeep.igethappy.audiorecorder.PitchView;
import com.example.singhrahuldeep.igethappy.audiorecorder.RawSamples;
import com.example.singhrahuldeep.igethappy.audiorecorder.Sound;
import com.example.singhrahuldeep.igethappy.audiorecorder.Storage;
import com.example.singhrahuldeep.igethappy.audiorecorder.encoders.*;
...
//        title.setText(targetFile.getName());
            ...
            public void onClick(View v) {
                ...
                encoding(new Runnable() {
                    ...
                    public void run() {
                        ...
                        intent.putExtra("audioFilePath", targetFile);
    ...
    void stopRecording(String status) {
        setState(status);
        pause.setImageResource(R.mipmap.ic_launcher);

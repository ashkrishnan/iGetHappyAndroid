...
import com.example.singhrahuldeep.igethappy.imagechooser.threads.*;
 ...
 * @author Beanie
 */
public abstract class MediaChooserManager extends BChooser implements
    ...
    @Override
    public String choose() throws ChooserException, ChooserException {
        if (listener == null) {
    ...
    public abstract void onProcessedFile(ChosenFile file);

...
import com.example.singhrahuldeep.igethappy.imagechooser.exceptions.ChooserException;
import com.example.singhrahuldeep.igethappy.imagechooser.factory.UriFactory;
import static com.example.singhrahuldeep.igethappy.imagechooser.helpers.StreamHelper.closeSilent;
import static com.example.singhrahuldeep.igethappy.imagechooser.helpers.StreamHelper.verifyCursor;
...
public abstract class BChooser {
     ...
     *
     */
    public abstract String choose() throws ChooserException, ChooserException;
     ...
     * @return
     */
    public long queryProbableFileSize(Uri uri, Context context) throws ChooserException {
    ...
    public abstract void onProcessedImage(ChosenImage image);

    public abstract void onProcessedVideo(ChosenVideo video);

    public abstract void onProcessedVideos(ChosenVideos videos);

    public abstract void onProcessedImages(ChosenImages images);
}

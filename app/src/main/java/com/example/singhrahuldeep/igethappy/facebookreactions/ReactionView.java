...
import static com.example.singhrahuldeep.igethappy.facebookreactions.CommonDimen.DIVIDE;
...
public class ReactionView extends View  {
    ...
    public void setInterfaceListener(OnEmojiSelectedListener onEmojiSelectedListener) {
    ...
    private void init() {
        ...
        emotions[2] = new Emotion(getContext(), "Haha", R.drawable.cry);
        emotions[3] = new Emotion(getContext(), "Wow", R.drawable.wow);
        emotions[4] = new Emotion(getContext(), "Sad", R.drawable.haha);
        emotions[5] = new Emotion(getContext(), "Angry", R.drawable.haha);
        initElement();
    }
    ...
    public boolean onTouchEvent(MotionEvent event) {
        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_UP:
                ...
                for (int i = 0; i < emotions.length; i++) {
                    if (event.getX() > emotions[i].currentX && event.getX() < emotions[i].currentX + emotions[i].currentSize) {
                        onEmojiSelectedListener.onEmojiSelected(emotions[i].imageResource);
                        break;
                    }
                }

...
public class MediaItem implements Parcelable {
    ...
    public Uri getFilteredUri() {
        return filteredUri;
    }

    public void setFilteredUri(Uri filteredUri) {
        this.filteredUri = filteredUri;
    }

    private Uri filteredUri=null;
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        if (this.filteredUri == null) {
            ...
            dest.writeString(this.filteredUri.toString());
        }
    }
    ...
    public MediaItem(Parcel in) {
        ...
        String filter=in.readString();
        if (!TextUtils.isEmpty(filter))
            this.filteredUri = Uri.parse(filter);
    }
     ...
     */
    public String getPathOrigin(Context context,Uri uriPath) {
        return getPathFromUri(context, uriPath);
    }
